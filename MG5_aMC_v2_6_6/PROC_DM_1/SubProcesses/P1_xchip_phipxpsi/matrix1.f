...
C     
      ...
      DATA (NHEL(I,   1),I=1,3) / 1, 0,-1/
      DATA (NHEL(I,   2),I=1,3) / 1, 0, 1/
...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WPSI)
      ...
      CALL IXXXXX(P(0,1),MDL_MCHI,NHEL(1),+1*IC(1),W(1,1))
      CALL SXXXXX(P(0,2),+1*IC(2),W(1,2))
      CALL OXXXXX(P(0,3),MDL_MPSI,NHEL(3),+1*IC(3),W(1,3))
C     Amplitude(s) for diagram number 1
      CALL FFS1_0(W(1,1),W(1,3),W(1,2),GC_124,AMP(1))
