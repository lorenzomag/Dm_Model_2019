...
C     ----------
     ...
     $   , ZERO)
        FK_MDL_WNN2 = SIGN(MAX(ABS(MDL_WNN2), ABS(MDL_MNN2
     $   *SMALL_WIDTH_TREATMENT)), MDL_WNN2)
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WPSI)
      ...
      CALL OXXXXX(P(0,4),MDL_MNN2,NHEL(4),+1*IC(4),W(1,4))
      CALL FFS3_3(W(1,3),W(1,4),GC_108,MDL_MPHI, FK_MDL_WPHI,W(1,5))
      CALL OXXXXX(P(0,5),MDL_MPSI,NHEL(5),+1*IC(5),W(1,4))
      CALL FFS1_1(W(1,4),W(1,5),GC_124,MDL_MCHI, FK_MDL_WCHI,W(1,3))
      CALL IXXXXX(P(0,6),MDL_MCHI,NHEL(6),-1*IC(6),W(1,4))
      CALL FFV1P0_3(W(1,1),W(1,2),GC_1,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,4),W(1,3),W(1,5),GC_4,AMP(1))
      CALL FFV2_3_3(W(1,1),W(1,2),GC_83,GC_76,MDL_MZ, FK_MDL_WZ,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,4),W(1,3),W(1,5),GC_78,AMP(2))
