...
C     
C     Process: s s~ > phi+ phi- WEIGHTED<=4 @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     ----------
     ...
     $   ), ZERO)
      ...
      CALL FFS4_3(W(1,1),W(1,2),GC_146,MDL_MH, FK_MDL_WH,W(1,5))
C     Amplitude(s) for diagram number 1
      CALL SSS1_0(W(1,5),W(1,4),W(1,3),GC_94,AMP(1))
      CALL FFV1P0_3(W(1,1),W(1,2),GC_1,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL VSS1_0(W(1,5),W(1,4),W(1,3),GC_3,AMP(2))
      CALL FFV2_3_3(W(1,1),W(1,2),GC_83,GC_76,MDL_MZ, FK_MDL_WZ,W(1,5))
C     Amplitude(s) for diagram number 3
      CALL VSS1_0(W(1,5),W(1,4),W(1,3),GC_79,AMP(3))
