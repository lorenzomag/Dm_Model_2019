void selection_25()
{
  ...
  S26_DELTAR_0->SetBinContent(3,0.0);
  S26_DELTAR_0->SetBinContent(4,0.0);
  S26_DELTAR_0->SetBinContent(5,0.0);
  S26_DELTAR_0->SetBinContent(6,0.0);
  S26_DELTAR_0->SetBinContent(7,0.0);
  S26_DELTAR_0->SetBinContent(8,0.0);
  S26_DELTAR_0->SetBinContent(9,0.0);
  S26_DELTAR_0->SetBinContent(10,0.0);
  S26_DELTAR_0->SetBinContent(11,0.0);
  S26_DELTAR_0->SetBinContent(12,0.0);
  S26_DELTAR_0->SetBinContent(13,0.0);
  S26_DELTAR_0->SetBinContent(14,0.0);
  S26_DELTAR_0->SetBinContent(15,0.0);
  S26_DELTAR_0->SetBinContent(16,0.0);
  S26_DELTAR_0->SetBinContent(17,0.0);
  S26_DELTAR_0->SetBinContent(18,0.0);
  S26_DELTAR_0->SetBinContent(19,0.0);
  S26_DELTAR_0->SetBinContent(20,0.0);
  S26_DELTAR_0->SetBinContent(21,0.0);
