void selection_6()
{
  ...
  S7_ETA_0->SetBinContent(16,0.0);
  S7_ETA_0->SetBinContent(17,0.0);
  S7_ETA_0->SetBinContent(18,0.0);
  S7_ETA_0->SetBinContent(19,0.0);
  S7_ETA_0->SetBinContent(20,0.0);
  S7_ETA_0->SetBinContent(21,0.0);
  S7_ETA_0->SetBinContent(22,0.0);
  S7_ETA_0->SetBinContent(23,0.0);
  S7_ETA_0->SetBinContent(24,0.0);
  S7_ETA_0->SetBinContent(25,0.0);
