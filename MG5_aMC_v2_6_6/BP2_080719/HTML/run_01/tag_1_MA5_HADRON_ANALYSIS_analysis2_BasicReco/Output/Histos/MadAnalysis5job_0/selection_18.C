void selection_18()
{
  ...
  S19_M_0->SetBinContent(11,0.0);
  S19_M_0->SetBinContent(12,0.0);
  S19_M_0->SetBinContent(13,0.0);
  S19_M_0->SetBinContent(14,0.0);
  S19_M_0->SetBinContent(15,0.0);
  S19_M_0->SetBinContent(16,0.0);
  S19_M_0->SetBinContent(17,0.0);
  S19_M_0->SetBinContent(18,0.0);
  S19_M_0->SetBinContent(19,0.0);
  S19_M_0->SetBinContent(20,0.0);
  S19_M_0->SetBinContent(21,0.0);
  S19_M_0->SetBinContent(22,0.0);
  S19_M_0->SetBinContent(23,0.0);
  ...
  stack->GetXaxis()->SetTitle("M [ e_{1} j_{2} ] (GeV/c^{2}) ");
