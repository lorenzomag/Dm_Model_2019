...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WPSI)
      ...
      CALL IXXXXX(P(0,5),MDL_MNN2,NHEL(5),-1*IC(5),W(1,5))
      CALL FFS2_3(W(1,5),W(1,4),GC_108,MDL_MPHI, FK_MDL_WPHI,W(1,6))
      CALL IXXXXX(P(0,6),MDL_MPSI,NHEL(6),-1*IC(6),W(1,5))
      CALL FFS1_2(W(1,5),W(1,6),GC_124,MDL_MCHI, FK_MDL_WCHI,W(1,4))
