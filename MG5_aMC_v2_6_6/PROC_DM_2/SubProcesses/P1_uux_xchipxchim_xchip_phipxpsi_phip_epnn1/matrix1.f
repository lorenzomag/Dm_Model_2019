...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WCHI)
        FK_MDL_WNN1 = SIGN(MAX(ABS(MDL_WNN1), ABS(MDL_MNN1
     $   *SMALL_WIDTH_TREATMENT)), MDL_WNN1)
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WPSI)
      ...
      CALL OXXXXX(P(0,4),MDL_MNN1,NHEL(4),+1*IC(4),W(1,4))
      CALL FFS3_3(W(1,3),W(1,4),GC_107,MDL_MPHI, FK_MDL_WPHI,W(1,5))
