...
V_7 = Vertex(name = 'V_7',
             particles = [ P.G0, P.G0, P.phi__minus__, P.phi__plus__ ],
             color = [ '1' ],
             lorentz = [ L.SSSS1 ],
             couplings = {(0,0):C.GC_52})

V_8 = Vertex(name = 'V_8',
             particles = [ P.G__minus__, P.G__plus__, P.phi__minus__, P.phi__plus__ ],
             color = [ '1' ],
             lorentz = [ L.SSSS1 ],
             couplings = {(0,0):C.GC_52})
...
V_55 = Vertex(name = 'V_55',
              ...
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS2, L.FFS3 ],
              couplings = {(0,0):C.GC_145,(0,1):C.GC_147})
...
V_84 = Vertex(name = 'V_84',
              particles = [ P.P__tilde__Chi__minus__, P.P__tilde__Psi, P.phi__plus__ ],
              color = [ '1' ],
              lorentz = [ L.FFS1 ],
              couplings = {(0,0):C.GC_124})

V_85 = Vertex(name = 'V_85',
              particles = [ P.NN1__tilde__, P.e__minus__, P.phi__plus__ ],
              color = [ '1' ],
              lorentz = [ L.FFS2 ],
              couplings = {(0,0):C.GC_107})

V_86 = Vertex(name = 'V_86',
              particles = [ P.NN2__tilde__, P.mu__minus__, P.phi__plus__ ],
              color = [ '1' ],
              lorentz = [ L.FFS2 ],
              couplings = {(0,0):C.GC_108})

V_87 = Vertex(name = 'V_87',
              particles = [ P.NN3__tilde__, P.ta__minus__, P.phi__plus__ ],
              color = [ '1' ],
              lorentz = [ L.FFS2 ],
...
V_97 = Vertex(name = 'V_97',
              particles = [ P.P__tilde__Psi__tilde__, P.P__tilde__Chi__plus__, P.phi__minus__ ],
              color = [ '1' ],
              lorentz = [ L.FFS1 ],
              couplings = {(0,0):C.GC_124})

V_98 = Vertex(name = 'V_98',
              particles = [ P.e__plus__, P.NN1, P.phi__minus__ ],
              color = [ '1' ],
              lorentz = [ L.FFS3 ],
              couplings = {(0,0):C.GC_107})

V_99 = Vertex(name = 'V_99',
              particles = [ P.mu__plus__, P.NN2, P.phi__minus__ ],
              color = [ '1' ],
              lorentz = [ L.FFS3 ],
              couplings = {(0,0):C.GC_108})

V_100 = Vertex(name = 'V_100',
               particles = [ P.ta__plus__, P.NN3, P.phi__minus__ ],
               color = [ '1' ],
               lorentz = [ L.FFS3 ],
               couplings = {(0,0):C.GC_109})
...
V_188 = Vertex(name = 'V_188',
               ...
               couplings = {(0,0):C.GC_84,(0,1):C.GC_77})
...
V_191 = Vertex(name = 'V_191',
               ...
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFV2, L.FFV3 ],
               couplings = {(0,0):C.GC_83,(0,1):C.GC_76})
...
V_197 = Vertex(name = 'V_197',
               ...
               color = [ '1' ],
               lorentz = [ L.FFV2, L.FFV3 ],
               couplings = {(0,0):C.GC_85,(0,1):C.GC_79})
