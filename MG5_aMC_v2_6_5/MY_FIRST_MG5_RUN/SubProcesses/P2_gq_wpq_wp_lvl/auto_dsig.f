...
C     
C     Process: g u > w+ d WEIGHTED<=3 @2
C     *   Decay: w+ > e+ ve WEIGHTED<=2
C     Process: g c > w+ s WEIGHTED<=3 @2
C     *   Decay: w+ > e+ ve WEIGHTED<=2
C     Process: g u > w+ d WEIGHTED<=3 @2
C     *   Decay: w+ > mu+ vm WEIGHTED<=2
C     Process: g c > w+ s WEIGHTED<=3 @2
C     *   Decay: w+ > mu+ vm WEIGHTED<=2
C     Process: g d~ > w+ u~ WEIGHTED<=3 @2
C     *   Decay: w+ > e+ ve WEIGHTED<=2
C     Process: g s~ > w+ c~ WEIGHTED<=3 @2
C     *   Decay: w+ > e+ ve WEIGHTED<=2
C     Process: g d~ > w+ u~ WEIGHTED<=3 @2
C     *   Decay: w+ > mu+ vm WEIGHTED<=2
C     Process: g s~ > w+ c~ WEIGHTED<=3 @2
...
C       Flip CM_RAP (to get rapidity right)
      ...
      IF (PASSCUTS(P1)) THEN
        IF(IPROC.EQ.1) DSIGPROC=DSIG1(P1,WGT,IMODE)  ! g u > e+ ve d
        IF(IPROC.EQ.2) DSIGPROC=DSIG2(P1,WGT,IMODE)  ! g d~ > e+ ve u~
      ENDIF
