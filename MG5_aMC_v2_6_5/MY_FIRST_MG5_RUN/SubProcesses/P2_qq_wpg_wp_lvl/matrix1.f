...
C     
C     Process: u d~ > w+ g WEIGHTED<=3 @2
C     *   Decay: w+ > e+ ve WEIGHTED<=2
C     Process: c s~ > w+ g WEIGHTED<=3 @2
C     *   Decay: w+ > e+ ve WEIGHTED<=2
C     Process: u d~ > w+ g WEIGHTED<=3 @2
...
C     ----------
     ...
     $   , ZERO)
      ...
      CALL FFV1_2(W(1,1),W(1,4),GC_11,ZERO, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 1
      CALL FFV2_0(W(1,3),W(1,2),W(1,5),GC_100,AMP(1))
      CALL FFV1_1(W(1,2),W(1,4),GC_11,ZERO, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 2
      CALL FFV2_0(W(1,1),W(1,3),W(1,5),GC_100,AMP(2))
