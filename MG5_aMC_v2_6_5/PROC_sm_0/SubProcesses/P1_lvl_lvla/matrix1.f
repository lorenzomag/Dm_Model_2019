...
C     ----------
     ...
     $   , ZERO)
      ...
      CALL FFV2_3(W(1,2),W(1,1),GC_100,MDL_MW, FK_MDL_WW,W(1,6))
      CALL FFV2_3(W(1,3),W(1,4),GC_100,MDL_MW, FK_MDL_WW,W(1,7))
C     Amplitude(s) for diagram number 1
      CALL VVV1_0(W(1,5),W(1,6),W(1,7),-GC_3,AMP(1))
      CALL FFV1_2(W(1,3),W(1,5),GC_3,ZERO, FK_ZERO,W(1,8))
C     Amplitude(s) for diagram number 2
      CALL FFV2_0(W(1,8),W(1,4),W(1,6),GC_100,AMP(2))
      CALL FFV1_1(W(1,1),W(1,5),GC_3,ZERO, FK_ZERO,W(1,8))
C     Amplitude(s) for diagram number 3
      CALL FFV2_0(W(1,2),W(1,8),W(1,7),GC_100,AMP(3))
