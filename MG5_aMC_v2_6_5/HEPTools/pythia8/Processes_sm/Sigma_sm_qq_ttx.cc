...
double Sigma_sm_qq_ttx::sigmaHat() 
{
...
void Sigma_sm_qq_ttx::setIdColAcol() 
{
  if(id1 == -3 && id2 == 3)
  {
  ...
  // Pick color flow
  int ncolor[1] = {2}; 
  if((id1 == 2 && id2 == -2 && id3 == 6 && id4 == -6) || (id1 == 4 && id2 == -4
      && id3 == 6 && id4 == -6) || (id1 == 1 && id2 == -1 && id3 == 6 && id4 ==
      -6) || (id1 == 3 && id2 == -3 && id3 == 6 && id4 == -6))
  {
    vector<double> probs; 
  ...
  else if((id1 == -2 && id2 == 2 && id3 == 6 && id4 == -6) || (id1 == -4 && id2
      == 4 && id3 == 6 && id4 == -6) || (id1 == -1 && id2 == 1 && id3 == 6 &&
      id4 == -6) || (id1 == -3 && id2 == 3 && id3 == 6 && id4 == -6))
  {
    vector<double> probs; 
    double sum = jamp2[0][0] + jamp2[0][1]; 
    for(int i = 0; i < ncolor[0]; i++ )
...
double Sigma_sm_qq_ttx::weightDecay(Event& process, int iResBeg, int iResEnd) 
{
...
void Sigma_sm_qq_ttx::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double Sigma_sm_qq_ttx::matrix_1_uux_ttx() 
{
  int i, j; 
  // Local variables
  const int ngraphs = 1; 
